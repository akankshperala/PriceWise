...
//   console.log(product)
  ...
  return (
    <div className="product-container p-2 mx-6">
      ...
      <div className="flex flex-col gap-8">
        ...
        <button className=" px-6 py-3 w-fit  bg-black text-white rounded-4xl flex items-center justify-center gap-3 hover:bg-gray-800">
